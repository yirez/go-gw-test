    ...
    "paths": {
        ...
        "/auth/service-token": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Service token payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.ServiceTokenRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/types.ServiceTokenResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.ValidateRequest"
                        }
                    }
                ],
                "responses": {
